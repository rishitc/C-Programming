...
int main() {
    ...
    for(int slideCount = 0, sum; slideCount < number_of_slides; ++slideCount) {
        sum = 0;
        int count = 0;
        ...
        if(count != 0)
            ...
            printf("Division by 0 error in %d", __LINE__ - 2);
            exit(0);
        }
    }
